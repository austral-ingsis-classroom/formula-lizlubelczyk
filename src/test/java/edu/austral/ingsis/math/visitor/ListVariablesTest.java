...
public class ListVariablesTest {
  ...
  public void shouldListVariablesFunction4() {
    Function function = new Potentiation (new Division(new Value(27), new Variable("a")), new Variable("b"));
    final Collection<String> result = variableGetterVisitor.getVariables(function);
  ...
  public void shouldListVariablesFunction5() {
    Function function = new Potentiation(new Variable("z"), new Division(new Value(1), new Value(2)));
    final Collection<String> result = variableGetterVisitor.getVariables(function);
